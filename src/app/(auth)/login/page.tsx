        ...
        <div className="max-w-2xl">
          ...
          >
            ...
            <div className="button mt-2">
              <button className="bg-blue-600 hover:bg-blue-800 text-white font-bold p-4 w-full rounded-full">
                Sign in
              </button>
            </div>

            <div className="google_auth mt-4 pt-1">
              <button className="flex items-center justify-center gap-2 w-full border p-3  border-gray-700 rounded-full">
                <Image
                  src={"/google.svg"}
                  alt="google"
                  width={50}

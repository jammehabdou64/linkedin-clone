  ...
  return (
    <div className="post rounded-xl bg-white p-4 mt-3 mb-3">
      ...
      <div className="post_button flex justify-evenly mt-1 pt-1">
        <div className="flex p-1 xs:p-2 items-center cursor-pointer hover:bg-gray-200">
          <MdOutlineThumbUp size={22} />
          <p className=" text-gray-500 xs:font-semibold ">Like</p>
        </div>
        <div className="flex p-1 xs:p-2 items-center cursor-pointer hover:bg-gray-200">
          <MdOutlineChat size={22} />
          <p className=" text-gray-500 xs:font-semibold ">comment</p>
        </div>
        <div className="flex p-1 xs:p-2 items-center cursor-pointer hover:bg-gray-200">
          <MdOutlineShare size={22} />
          <p className=" text-gray-500 xs:font-semibold ">share</p>
        </div>
        <div className="flex p-1 xs:p-2 items-center cursor-pointer hover:bg-gray-200">
          <MdOutlineSend size={22} />
          <p className=" text-gray-500 xs:font-semibold ">send</p>
        </div>
      </div>
    </div>
  );
